...
const NavigatorLayout = (props: NavigatorLayoutProps) => {
  ...
  const {
    ...
    onOpen: aiGeneratorOpen,
    onClose: aiGeneratorClose,
  } = useDisclosure();
    ...
    <>
      ...
      <div className="navigator-layout">
        <div className="navigator-layout-content">
          {isSelectMode && (
            <div className="select-mode-overlay" onClick={() => setIsSelectMode(false)}>
              ...
              <div className="select-mode-types">
                <div
                  className="select-mode-type upload-button"
                ...
                <div
                  className="select-mode-type ai-button"
          ...
          {hasScrollArea && <ScrollArea>{children}</ScrollArea>}
...
const Menu = ({ icon, label, root }: NavData) => {
  ...
  return (
    <div className="menu" onClick={() => navigate(`${root}`)}>
