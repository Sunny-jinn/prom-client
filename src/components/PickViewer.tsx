...
const PickContent = ({
  ...
  const getPick = async () => {
    try {
      ...
      if (followings.find((el) => el.id === result.user.id)) {
        setIsFollow(true);
      }
      ...
      <>
        ...
        <div className="pick-content">
                  ...
                  <div className="pick-features-main">
                    <div className="pick-features-info">
                      <div className="pick-features-user-wrapper">
                        ...
                        {user?.id !== pick.user.id && (
                          <button
                            className={cn('pick-follow-button', { isFollow: isFollow })}
                      ...
                      <div
                        ...
                        className={cn('pick-features-content', { isOpen: isContentOpen })}
                      >
                    ...
                    <div className="pick-features-interaction">
                      <div className="pick-feature-element">
                        <Likes
                          fill={isUserLike ? '#7bf7ff' : '#ffffff'}
                          onClick={() => onClickLike()}
                        />
                        {!isNaN(Number(pick.likeCounts)) && (
          ...
          <input
            ...
            disabled={!ready}
            style={{
              background: `linear-gradient(to right, #7bf7ff ${playTime * 100}%, #554F4F 0)`,
            }}
