...
// 타입 가드 함수
export function isCustomView(view: AIGeneratorGridViewType | AIGeneratorCustomViewType): view is AIGeneratorCustomViewType {
  return view.type === 'CUSTOM';
}

export const AI_GENERATOR_DATA = (params: AI_GENERATOR_DATA_PARAMS): Record<Post.PostCategory, AIGeneratorData> => {
  const
    {
          ...
          data  : [
            {
              label      : '팝',
              value      : 'POP',
              description: '팝 음악은 대중적이고 친숙한 멜로디와 경쾌한 리듬이 특징인 음악 장르입니다. 다양한 악기와 전자음향을 활용해 쉽게 따라 부를 수 있는 멜로디를 강조하며, 중독성 있는 후렴구가 자주 포함됩니다.',
            },
            {
              label      : '힙합',
              value      : 'HIPHOP',
              description: '리듬과 비트를 중시하는 음악으로, 랩과 강한 리듬감이 특징입니다. 자유로운 표현과 강렬한 에너지가 돋보이며, 감정과 이야기를 풀어내기 좋은 장르입니다.',
            },
            {
              label      : '락',
              value      : 'ROCK',
              description: '대중적이고 다양한 스타일의 음악입니다. 쉬운 멜로디와 반복적인 구조로 누구나 쉽게 즐길 수 있으며, 트렌디한 사운드와 감정 표현에 적합합니다.',
            },
            {
              label      : 'R&B',
              value      : 'R&B',
              description: '감미로운 멜로디와 소울풀한 보컬이 특징인 음악입니다. 부드럽고 감성적인 분위기를 만들어내며, 감정적인 표현과 리듬감을 잘 살릴 수 있습니다.',
            },
            {
              label      : 'EDM',
              value      : 'EDM',
              description: '전자음악을 기반으로 한 신나는 비트와 클럽 음악입니다. 강렬한 드롭과 활기 넘치는 리듬이 특징이며, 파티와 댄스에 적합한 에너지를 제공합니다.',
            },
          ],
        },
        {
          ...
          data: [
            {
              label      : '저음',
              value      : 'LOW',
              description: '저음은 낮고 깊은 소리로, 드럼과 베이스 같은 악기에서 주로 들을 수 있습니다. 강력하고 풍부한 느낌을 주며, 곡에 깊이와 리듬감을 추가합니다.',
            },
            {
              label      : '중음',
              value      : 'MIDDLE',
              description: '중음은 대부분의 보컬과 주요 악기에서 들을 수 있는 소리입니다. 곡의 멜로디와 하모니를 형성하며, 음악의 중심이 되는 부분입니다.',
            },
            {
              label      : '고음',
              value      : 'HIGH',
              description: '고음은 높은 주파수의 소리로, 심벌즈와 고음 악기에서 주로 들을 수 있습니다. 밝고 선명한 느낌을 주며, 곡에 섬세함과 에너지를 더합니다.',
            },
          ],
        },
        {
          ...
          data  : [
            {
              label      : '추상적',
              value      : 'ABSTRACT',
              description: '감정과 상상을 자유롭게 표현할 수 있는 카테고리입니다. 복잡한 형태와 색상을 활용하여 독창적인 작품을 만들어 보세요.',
            },
            { label: '사실적', value: 'REALISM' },
            {
              label      : '미니멀',
              value      : 'MINIMAL',
              description: '간결하고 정제된 디자인을 중심으로 한 카테고리입니다. 단순한 형태와 색상을 사용하여 강렬하고 명확한 메시지를 전달해 보세요.',
            },
        ...
        },
        {
          ...
          data  : [
            { label: '간결하고 직설적인', value: 'COMPACT', description: '군더더기 없이 명확하게 전달하는 문체입니다. \n예) "그는 문을 열고 나갔다."' },
            {
              label      : '서사적이고 묘사적인',
              value      : 'DESCRIPTIVE',
              description: '상황과 장면을 상세하게 그려내는 문체입니다.\n예) "바람이 창문을 스치며, 그는 천천히 문을 열었다."',
            },
            {
              label      : '고전적이고 우아한',
              value      : 'CLASSIC',
              description: '전통적이고 문학적인 느낌의 문체입니다.\n예) "그는 조용히 문을 열고, 바깥 세상으로 나아갔다."',
            },
            {
              label      : '현대적인 대화체',
              value      : 'MODERN',
              description: '자연스러운 대화와 일상적인 표현을 사용하는 문체입니다.\n예) "그가 말없이 문을 열고 나가버렸어."',
            },
          ],
        },
        {
