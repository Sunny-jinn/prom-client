  ...
  },
  {
    ...
    contents: [
      ...
      },
      {
        type: 'text',
        content:
          '상냥함이 깃들면 변화가 수월해진다. (p.291) 2024년이 지나기 전 읽을 만한 SF소설을 찾고 있다면 옥타비아 버틀러의 <씨앗을 뿌리는 사람의 우화>는 어떨까. 일기로 전개되는 책의 특성상 각 챕터에서 2024년 현재 읽고 있는 오늘의 날짜를 찾아보는 재미도 있다. 타인의 아픔에 진정으로 공감할 수 있는 사람이야말로 종말의 시대에 변화를 불러올 수 있는 존재라는 작가의 메시지는 그 어느 때보다도 2024년 현재에 유효해 보인다.',
      },
    ],
  },
  {
    ...
    contents: [
      {
        type: 'text',
        content:
          "지난 15~16일 강원도 철원군 고석정 일대에서 'DMZ 피스트레인 뮤직페스티벌'이 열렸다. /공미나 기자\n" +
